		...
		<nav class="col-md-2 bg-light">
			<div class="sidebar-sticky">
				<ul class="nav flex-column">
					<li class="nav-item"><a class="nav-link" href="index.php" style="">Home</a></li>
	       ...
	       <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4 jumbotron" style="height: 600px">
			<div class="card">
				...
				<div class="card-body">
					...
					<a href="form.php" type="button" class="btn btn-primary btn-block">Button 1 </a><br>
					<h3>Profil</h3>
					<a href="form.php" type="button" class="btn btn-primary btn-block">Button 1 </a>
				</div>
